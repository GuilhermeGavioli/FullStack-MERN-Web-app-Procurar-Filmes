...
return (
    ...
    sx={{
      ...
      padding: '0',
      boxShadow: 'none',
      border: isDarkMode ? `1px solid ${currentTheme.palette.sec}` : '1px solid rgb(225,225,225)',
      ...
      width: '100%',
          maxWidth: '300px',
      minWidth: 'unset',       borderRadius: '10px',
      background: currentTheme.palette.logininputbg
    }}
    >
...
<svg style={{padding: 0, marginTop: '5px', marginRight: '5px'}} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 48 48">
