...
function MainPage() {
  ...
  function runGenreChange(g){
    ...
    const url = `http://procurarfilmes.xyz/movies/${page}/genres?genre=${genre}`
  ...
  async function getRandomSample(){
    ...
    const url = `http://procurarfilmes.xyz/movies/sample/random`
  const res = await fetch(url, {
    headers: {
      'authorization': `Bearer ${localStorage.getItem('access_token')}`
    }
  ...
  async function getOldies(){
    ...
    setOldMoviesRetry(true)
      ...
      const url = `http://procurarfilmes.xyz/movies/sample/olddies`
    const res = await fetch(url, {
      headers: {
        'authorization': `Bearer ${localStorage.getItem('access_token')}`
      }
  ...
  const getMoreMovies = async () => {
    ...
    const res = await fetch(`http://procurarfilmes.xyz/movies/${page}/genres?genre=${genre}`, {
      headers: {
        'authorization': `Bearer ${localStorage.getItem('access_token')}`
      }
    })
