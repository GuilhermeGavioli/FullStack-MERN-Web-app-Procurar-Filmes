...
{/* <SearchInput placeholder="Search..." type="text" style={{marginTop: '80px', fontFamily: 'roboto', color: 'white', background: grey[800], }}/> */}
  ...
  <div style={{height: '45px', width: '100%', padding: '15px 10px 0 10px'}}>
    <BreadCrumb></BreadCrumb>
     ...
     <div style={{padding: '15px 20px 0 20px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
     ...
     <div style={{padding: '15px 20px 0 20px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
        <MovieImage   cover={movie.cover} rate={movie.rate} ></MovieImage>
     </div>
        
    
     <div style={{padding: '15px 20px 0 20px', display: 'flex', flexDirection: 'column', alignItems: 'end', justifyContent: 'center'}}>
       
        {/* <Typography variant="subtitle1" gutterBottom sx={{margin: 0, padding: 0}}>
        {movie.genre}
      </Typography> */}
        <Typography variant="body2" gutterBottom sx={{margin: 0, padding: 0, color: grey[400], textAlign: 'center'}}>
        {movie.description}
      </Typography>
     </div>
    ...
    <div style={{padding: '15px 20px 0 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
       
       {/* <Typography variant="subtitle1" gutterBottom sx={{margin: 0, padding: 0}}>
       {movie.genre}
     </Typography> */}
       <Typography variant="body2" gutterBottom sx={{margin: 0, padding: 0, color: grey[400], textAlign: 'start'}}>
       Genre: Drama
     </Typography>
       <Typography variant="body2" gutterBottom sx={{margin: 0, padding: 0, color: grey[400], textAlign: 'start'}}>
       Director: Who Knows
